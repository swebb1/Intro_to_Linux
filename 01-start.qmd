...
Although Linux has thousands of commands, there are a few that are used most of the time. Even so, it can be daunting to try to memorise new Linux commands. The cheat sheet below is a really handy resource to get you started on the command line.

-   [Linux command cheat sheet](https://upload.wikimedia.org/wikipedia/commons/7/79/Unix_command_cheatsheet.pdf)
