...
[USERNAME]@bifx-core1:~/course$ mv analysis analysis_raw
[USERNAME]@bifx-core1:~/course$ ls
...
[USERNAME]@bifx-core1:~/course$ bash /library/training/Intro_to_Linux/analysis_improved.sh
Creating STAR index...
...
[USERNAME]@bifx-core1:~/course$ cat analysis/run_report.txt
/library/training/Intro_to_Linux/analysis_improved.sh run completed successfully.
