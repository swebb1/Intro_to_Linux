...
A convenient way to experiment with glob patterns (and to make sure they match the files you want them to) is to use the `echo` command, which prints its arguments to the command line:
...
-rw-r--r-- 1 [USERNAME] [USERNAME] 1.5M Nov 12  2020 bioinformatics_on_the_command_line_files/raw_yeast_rnaseq_data.fastq
[USERNAME]@bifx-core1:~/course$ chmod a-w bioinformatics_on_the_command_line_files/raw_yeast_rnaseq_data.fastq
[USERNAME]@bifx-core1:~/course$ ls -lah bioinformatics_on_the_command_line_files/raw_yeast_rnaseq_data.fastq
-r--r--r-- 1 [USERNAME] [USERNAME] 1.5M Nov 12  2020 bioinformatics_on_the_command_line_files/raw_yeast_rnaseq_data.fastq
